...
- PM 标准:`runs/kf-20260727T062537Z-62cc68a6/stages/pm_docs/attempt-1/MAP.md`(build/* 八章)
...
- IAP  reconcile:PM 文案(ai-and-privacy Commerce card、features F8、ACC-F8、data-model ExportCreditLedger)写 "10/30 credits 两档、初始 seed 3",与 yanran 目录(最低档 110/210 credits、initial_balance=100)不一致。**以 hash 绑定的 yanran 目录为唯一标准**,PM 文案修订走 MAP ## Gaps 路由 pm_docs。
...
- 要求:
  ...
  - 初始余额 = 目录 initial_balance **100**(首启 seed,transactions 记 grant);PM 文案 "10/30 两档 / seed 3" 作废,以目录为准。
