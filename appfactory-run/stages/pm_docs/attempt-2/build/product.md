...
StoreKit consumable(yanran balance catalog):Export Credit。核心打分/对比永久免费；导出 Verdict 卡消耗 1 枚；新用户首启赠 100 枚(yanran initial_balance=100)；售 473900(110 枚,$0.99)/ 473901(210 枚,$1.99)两档包。无订阅、无解锁制、无 Restore Purchases 入口(consumable 语义)。
