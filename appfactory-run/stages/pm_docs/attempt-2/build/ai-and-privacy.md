...
- why_not_factory_default: 无 AI 故不存在 "1 free AI then AI Unlock";付费对象是非 AI 的导出交付物,新用户首启 seed 100 枚(yanran initial_balance=100,目录契约非产品自定);价格档两档:product 473900 = 110 credits($0.99)/ product 473901 = 210 credits($1.99)
